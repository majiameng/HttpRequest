...
最新版查询 [https://search.maven.org/artifact/io.github.tinymeng/http-request](https://search.maven.org/artifact/io.github.tinymeng/http-request)
...
```java
   HttpUtil.down("https://github.com/majiameng/HttpRequest","path/");
```
...
```java
        ...
        # get
        Response response=HttpRequest.get("https://github.com/search?type=repositories")
        .queryMap("q","tinymeng")
...
logging:
  level:
    io.github.tinymeng.http.core: debug
```

post form 日志

```
16:49:14.092[main]DEBUG io.github.tinymeng.http.core.HttpLogger- -->GET http://192.168.1.13:9100/auth/login?q=tinymeng http/1.1
16:49:14.094[main]DEBUG io.github.tinymeng.http.core.HttpLogger-User-Agent:tinymeng
16:49:14.094[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Host:192.168.1.13:9100
16:49:14.094[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Connection:Keep-Alive
16:49:14.094[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Accept-Encoding:gzip
16:49:14.094[main]DEBUG io.github.tinymeng.http.core.HttpLogger- -->END GET
16:49:14.670[main]DEBUG io.github.tinymeng.http.core.HttpLogger-<--200OK http://192.168.1.13:9100/auth/login?q=tinymeng (575ms)
16:49:14.670[main]DEBUG io.github.tinymeng.http.core.HttpLogger-transfer-encoding:chunked
16:49:14.670[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Vary:Origin
16:49:14.670[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Vary:Access-Control-Request-Method
16:49:14.670[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Vary:Access-Control-Request-Headers
16:49:14.670[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Vary:Origin
16:49:14.670[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Vary:Access-Control-Request-Method
16:49:14.670[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Vary:Access-Control-Request-Headers
16:49:14.671[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Content-Type:application/json;charset=utf-8
16:49:14.671[main]DEBUG io.github.tinymeng.http.core.HttpLogger-Date:Tue,08Nov 2022 08:49:14GMT
16:49:14.671[main]DEBUG io.github.tinymeng.http.core.HttpLogger-
16:49:14.671[main]DEBUG io.github.tinymeng.http.core.HttpLogger-{"code":406,"msg":"Full authentication is required to access this resource"}
16:49:14.671[main]DEBUG io.github.tinymeng.http.core.HttpLogger-<--END HTTP(76-byte body)
response=Response{protocol=http/1.1,code=200,message=OK,url=http://192.168.1.13:9100/auth/login?q=tinymeng}
```
...
<dependency>
    <groupId>io.github.tinymeng</groupId>
    <artifactId>http-request-starter</artifactId>
    <version>0.4.6</version>
</dependency>
```
